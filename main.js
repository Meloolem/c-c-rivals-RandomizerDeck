...
document.querySelector("#button-random").onclick = function(){
    ...
    if(fraction == 'ГСБ') {
      unit1.src = uGDIimg.splice([random(0,31)],1);
      unit2.src = uGDIimg.splice([random(0,30)],1);
      unit3.src = uGDIimg.splice([random(0,29)],1);
      unit4.src = uGDIimg.splice([random(0,28)],1);
      unit5.src = uGDIimg.splice([random(0,27)],1);
      unit6.src = uGDIimg.splice([random(0,26)],1);
    } else{
      unit1.src = uNODimg.splice([random(0,31)],1);
      unit2.src = uNODimg.splice([random(0,30)],1);
      unit3.src = uNODimg.splice([random(0,29)],1);
      unit4.src = uNODimg.splice([random(0,28)],1);
      unit5.src = uNODimg.splice([random(0,27)],1);
      unit6.src = uNODimg.splice([random(0,26)],1);
    }
  }